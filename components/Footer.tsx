...
const Footer: React.FC<FooterProps> = ({ brandName, tagline, contact, address }) => {
  return (
    <footer className="py-16 md:py-20 bg-white border-t border-slate-100">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-col items-center md:items-start gap-3">
            <span className="text-xl md:text-2xl font-black tracking-tighter text-slate-900">{brandName}</span>
            <p className="text-red-600 font-black uppercase text-[10px] tracking-[0.2em] mb-1">{tagline}</p>
