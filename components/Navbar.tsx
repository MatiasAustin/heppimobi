...
const Navbar: React.FC<NavbarProps> = ({ brandName, tagline, logoUrl, accentColor, whatsappNumber }) => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-[9999] transition-all duration-500 ${isScrolled ? 'py-2 md:py-3' : 'py-4 md:py-6'}`}>
      <div className="container mx-auto px-4 md:px-6 flex justify-center relative">
        ...
        <div
          ref={menuRef}
          className={`absolute top-full left-4 right-4 mt-3 lg:hidden transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] ${isMenuOpen
