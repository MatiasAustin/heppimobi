        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-20">
          ...
          <div className="flex-1 relative w-full lg:max-w-xl order-2 px-4 md:px-0">
            <div className="relative z-10">
              ...
              <div className="absolute -bottom-10 -left-6 md:-bottom-20 md:-left-16 glass-card p-4 md:p-6 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl border-white/50 max-w-[130px] md:max-w-[180px] animate-bounce-slow">
              ...
              <div className="absolute -top-12 -right-8 md:top-[-100px] md:-right-20 glass-card w-[220px] p-4 md:p-5 rounded-[2rem] shadow-2xl border-white/50 animate-bounce-slow" style={{ animationDelay: '0.5s' }}>
